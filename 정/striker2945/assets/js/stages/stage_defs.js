...
(function (global) {
  ...
  const EASY = {
    E01: {
      ...
      waves: [
        W(0,   10, 2.5, 2, 'Basic',  'top-random', {noBullet:true}),
        W(12,  10, 2.0, 3, 'Basic',  'top-random', {}),
        W(24,  16, 3.0, 3, 'ZigZag', 'top-random', {amp:34,hz:1.0}),
      ],
    },
    E02: { name:'초원 방어선', lengthSec:75, bulletScale:0.8, waves:[
